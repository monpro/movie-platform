...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/monpro/Desktop/git_warehouse/movie-platform/guns-cinema/src/main/java");//这里写你自己的java目录
...
//        strategy.setInclude(new String[]{"mooc_banner_t", "mooc_cat_dict_t", "mooc_area_dict_t", "mooc_year_dict_t", "mooc_film_t", "mooc_film_info_t", "mooc_actor_t"});
        strategy.setInclude("mooc_brand_dict_t", "mooc_area_dict_t", "mooc_hall_dict_t", "mooc_cinema_t", "mooc_field_t", "mooc_hall_film_info_t");
